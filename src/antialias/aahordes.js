...
! function(n, r) {
    ...
    var he = ["armor", "weapon", "offhand", "glove", "armlet", "boot", "gem", "ring", "bag"],
        ...
        le = {};
		//XHORDES GLOBALIZATION: makes this object available for the item max stats code
    ...
    var Ee = {
        ...
        Ae = {
			...
			//XHORDES COMMMANDS: filter, blocking, fixed hideui, showplayer
	...
	x_hideUi = function(){
		document.getElementById("parent_ui").style.display = "none", Ii.namesprite.visible = !1, Ii.clansprite.visible = !1
	}
	x_showUi = function(){
		document.getElementById("parent_ui").style.display = "block", Ii.namesprite.visible = !0, Ii.clansprite.visible = !0
	}
    createUi = function(t) {
        ai.parent = {
